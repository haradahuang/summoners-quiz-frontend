    ...
    <PageLayout title={roomTitle} bgImg={roomBg}>
      ...
      {isJoined && isPreparing && prepareData && (
        <div className="game-panel question-transition" style={{ width: '95%', maxWidth: '600px', margin: '2vh auto', textAlign: 'center', padding: '2rem 1rem' }}>
           ...
           <div style={{ fontSize: '3.5rem', fontWeight: '900', color: qTypeColors[prepareData.type] || '#fff', textShadow: '0 0 20px rgba(255,255,255,0.3)', marginBottom: '1.5rem' }}>{qTypeLabels[prepareData.type]}</div>
          ...
          {hasAnswered ? (
            ...
            <>
              ...
              {currentQuestion?.type === 'order' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <p style={{ color: '#f1c40f', fontSize: '1rem', marginBottom: '5px', fontWeight: 'bold' }}>💡 由上而下排出正確順序</p>
              ...
              {currentQuestion?.type === 'match' && (
                <div>
                  <p style={{ color: '#f1c40f', fontSize: '1rem', marginBottom: '10px', fontWeight: 'bold' }}>💡 點擊上方魔靈，再點下方圖片配對</p>
